...
import { EmailOtpVerificationForm } from "@/features/email-verification/components/EmailOtpVerificationForm";

function EmailVerifyWordmark({ className = "" }: { className?: string }) {
  return (
  ...
  return (
    <div className="relative flex min-h-dvh flex-col bg-surface">
      <div className="px-4 pt-4 sm:px-6 sm:pt-5 lg:px-8 lg:pt-4">
        ...
        >
          <EmailVerifyWordmark className="text-[28px] sm:text-[30px]" />
        </Link>
      </div>
