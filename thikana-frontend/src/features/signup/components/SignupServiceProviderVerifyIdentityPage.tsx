...
import { TenantVerifyIdentityForm } from "@/features/signup/components/TenantVerifyIdentityForm";
...
export function SignupServiceProviderVerifyIdentityPage() {
  return (
    <div className="relative flex min-h-dvh flex-col bg-surface">
      ...
      <section className="relative flex flex-1 flex-col items-center justify-center px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <TenantVerifyIdentityForm
          backHref={routes.signUpServiceProviderVerifyNumber}
          nextHref={routes.signUpServiceProviderDetails}
        />
      </section>
    </div>
  );
