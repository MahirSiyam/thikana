...
function ConversationRow({
  ...
  return (
    <button
      type="button"
      onClick={onSelect}
      className={`relative flex h-[72px] w-full items-center gap-3 border-b border-[#f0f0ee] px-4 text-left transition-colors ${
        selected ? "bg-[#f5f5f3]" : "bg-white hover:bg-[#fafaf9]"
      }`}
    >
      {selected ? (
        <span
      ...
      <div className="relative size-11 shrink-0 overflow-hidden rounded-[22px]">
        <Image
    ...
    <section className="flex min-h-[520px] min-w-0 flex-1 flex-col overflow-hidden bg-white lg:min-h-[896px]">
      <div className="flex h-16 shrink-0 items-center justify-between gap-3 border-b border-[#e5e5e2] px-4 sm:px-6">
        ...
        {conversation.subject ? (
          <span className="hidden shrink-0 rounded-lg bg-[#fef3c7] px-2.5 py-1.5 font-inter text-[11px] font-semibold text-[#f59e0b] sm:inline-flex">
            {conversation.subject}
          </span>
        ) : null}
      </div>
      ...
      >
        ...
        <label className="sr-only" htmlFor="tenant-message-input">
          Type a message
        </label>
        <input
          id="tenant-message-input"
          type="text"
          value={draft}
        ...
        <button
          ...
          className="flex size-11 shrink-0 items-center justify-center rounded-[22px] bg-brand-dark focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-dark focus-visible:ring-offset-2"
        >
          <Image
      ...
      <div className="flex w-full flex-col gap-6">
        <header className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex h-10 w-full max-w-[360px] items-center gap-2 rounded-[20px] bg-[#f5f5f3] px-4">
            ...
            />
            <label className="sr-only" htmlFor="tenant-messages-search">
              Search messages
            </label>
            <input
        ...
        <div className="flex min-h-0 flex-col overflow-hidden rounded-xl border border-[#e5e5e2] bg-white lg:flex-row">
          <aside
          ...
          >
            <div className="p-4">
              <div className="flex h-9 items-center gap-2 rounded-lg border border-[#e5e5e2] px-3">
                ...
                />
                <label className="sr-only" htmlFor="tenant-chats-search">
                  Search chats
                </label>
                <input
                  id="tenant-chats-search"
                  type="search"
                  value={chatQuery}
