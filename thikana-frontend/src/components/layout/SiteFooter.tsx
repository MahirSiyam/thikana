...
export function SiteFooter() {
  return (
    <footer className="relative bg-black text-white">
      ...
      <div
        aria-hidden="true"
        className="absolute inset-0 bg-[url('/images/home/footer.png')] bg-cover bg-position-[center_42%] bg-no-repeat opacity-50 sm:bg-position-[center_40%] md:bg-center lg:bg-fixed lg:bg-position-[center_45%] xl:bg-center"
      />
